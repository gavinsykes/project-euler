...
parser.add_argument('--problem_number', type = int, help = 'The number of the problem that you wish to update')
parser.add_argument('--cpu_freq', type = int, help = 'The frequency of the CPU in MHz')
parser.add_argument('--input', type = int, help = 'The input provided to the function for solving the problem')
parser.add_argument('--language', help = 'The language the problem has been completed in')
parser.add_argument('--language_version', help = 'The version of the language')
parser.add_argument('--machine', help = 'The machine')
parser.add_argument('--memory', type = int, help = 'The available memory of the workstation in B')
parser.add_argument('--operating_system', help = 'The operating system')
parser.add_argument('--os_release', help = 'The release of the operating system')
parser.add_argument('--os_version', help = 'The version of the operating system')
parser.add_argument('--processor', help = 'The processor')
parser.add_argument('--time', type = float, help = 'The time taken to solve the problem')
parser.add_argument('--timestamp', type = int, help = 'The time that the function was run')
